...
public class EpidemiaZ {
	ChainingHashTable<cidadeInfectada> cidades = new ChainingHashTable<>(7);// decidir qual o tamanho ideal
	private Edge[] edges;
...
<<<<<<< HEAD
	...
	public void becomeInfectedAfterXDays(int x)
	{
		int count = 0;
		for(int i =1;i<size;i++)
		{
			if(union.getDistancia(i)<=x && union.getDistancia(i)> -1)
			{
				System.out.println(i);
				count++;
			}
...
>>>>>>> 3c15d79be10a77cc39e8fffa1f34d6d348ca96aa
